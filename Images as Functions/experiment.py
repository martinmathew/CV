...
def main():
    ...
    normalizedImg = np.zeros(hybrid_image.shape)
    normalizedImg = cv.normalize(hybrid_image, normalizedImg, 0, 255, cv.NORM_MINMAX)
    vis = vis_hybrid_image(normalizedImg)
