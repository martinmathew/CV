...
def part_2a():
    ...
    template_loc = {'y': 80, 'x': 170, 'w': 50, 'h': 50}
...
def part_2b():
    ...
    template_loc = {'x': 360, 'y': 119, 'w': 117, 'h': 189}
...
def part_5():
    ...
    """
    template_rect = [{'x': 290, 'y': 224, 'w': 50, 'h': 80}, {'x': 59, 'y': 155, 'w': 90, 'h': 171},
                     {'x': 0, 'y': 212, 'w': 32, 'h': 78}]
    ...
    # default.
    ps5.part_5(
        ps5.MDParticleFilterVelocity,  # particle filter model class
        template_rect,
        save_frames,
