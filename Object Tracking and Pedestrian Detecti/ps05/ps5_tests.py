...
class PS5_PF_Tests(unittest.TestCase):
    ...
    # def __init__(self, testName, num_particles, sigma_mse, sigma_dyn):
    #     super(PS5_PF_Tests, self).__init__(testName)
    ...
    def test_PF_base_1(self):
        test_path = "input_images/circle/1/"
        template_path = "input_images/circle/template.png"
    ...
    def test_PF_base_2(self):
        test_path = "input_images/circle/2/"
        template_path = "input_images/circle/template.png"
    ...
    def test_PF_base_2_trial(self):
        ...
        pf = ps5.ParticleFilter(frame, template,
                                ...
                                sigma_exp=self.sigma_mse, sigma_dyn=self.sigma_dyn,
                                template_coords=template_rect,
                                temp=template_rect)
    ...
    def test_PF_base_3(self):
        test_path = "input_images/circle/3/"
        template_path = "input_images/circle/template.png"
