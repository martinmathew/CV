...
class AssignmentTests(unittest.TestCase):
    ...
    def test_find_markers_wall_image(self):
        ...
        template = cv2.imread("input_images/template_proc.jpg.jpg")
        ...
        for f in file_names:
            ...
            test_image = cv2.imread(INPUT_DIR + f)
            rotated_template = ps3.rotated_templates()
            ret_markers = ps3.find_markers_quarters(test_image, rotated_template)
            ret_markers = ps3.sort_by_leftright(ret_markers)
